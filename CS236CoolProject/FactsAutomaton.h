...
#ifndef CS236COOLPROJECT_FACTSAUTOMATON_H
#define CS236COOLPROJECT_FACTSAUTOMATON_H
#include "Automaton.h"

class FactsAutomaton : public Automaton
{
private:
    const std::string matchString = "Facts";
...
#endif //CS236COOLPROJECT_FACTSAUTOMATON_H
